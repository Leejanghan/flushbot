...
/* PID GAIN */
#define P_GAIN_L 1.
#define I_GAIN_L 0.001
#define D_GAIN_L 0.001
#define P_GAIN_R 1.
#define I_GAIN_R 0.001
#define D_GAIN_R 0.001
...
class CEncoder
{
  ...
  public:
    bool check = false;
    byte initEncoder = 0;
    double rpm, ang_vel, dir_term, angVel_linear, angVel_merge, angVel_rotate;
