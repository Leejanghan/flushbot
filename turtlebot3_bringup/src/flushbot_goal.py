...
def movebase_client(x):
   ...
   # Creates a new goal with the MoveBaseGoal constructor
    ...
    if x==1:
        goal.target_pose.pose.position.x = -0.97363
        goal.target_pose.pose.position.y = 6.9828
        goal.target_pose.pose.orientation.z = 0.03656
        goal.target_pose.pose.orientation.w = 0.999816
    else: 
...
def backward_motion(duration):
    ...
    vel_msg = Twist()
    vel_msg.linear.x = -0.1  # Move backwards
    cmd_vel_pub.publish(vel_msg)
